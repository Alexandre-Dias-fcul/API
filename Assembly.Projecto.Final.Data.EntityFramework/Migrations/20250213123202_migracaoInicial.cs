    ...
    public partial class migracaoInicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AddressEntityLink", x => new { x.AddressesId, x.EntityLinksId });
                    table.ForeignKey(
                        name: "FK_AddressEntityLink_Addresses_AddressesId",
                        column: x => x.AddressesId,
                        principalTable: "Addresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AddressEntityLink_EntityLinks_EntityLinksId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AddressEntityLink_EntityLinksId",
                table: "AddressEntityLink",
